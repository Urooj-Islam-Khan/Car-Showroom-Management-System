...
//        Bill
    ...
    private void savePaymentToDatabase() {
        ...
        if (car_Id.isEmpty() || user_Id.isEmpty() || amount.isEmpty() || payment.isEmpty()) {
...
//  Clear form fields
    ...
    private void initComponents() {
        ...
        jPanel10.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 3, true), "PAYMENT", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Stencil", 1, 24), new java.awt.Color(2, 48, 71))); // NOI18N
        jPanel10.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(2, 48, 71));
        jLabel9.setText("USER ID");
        jPanel10.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, -1, -1));
        ...
        jPanel10.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 190, -1, -1));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(2, 48, 71));
        jLabel12.setText("PAYMENT METHOD");
        jPanel10.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 230, -1, -1));
        ...
        jPanel10.add(userId, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 110, 230, -1));
        ...
        jPanel10.add(carId, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 150, 230, -1));

        jSeparator3.setBackground(new java.awt.Color(2, 48, 71));
        jSeparator3.setForeground(new java.awt.Color(2, 48, 71));
        jPanel10.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 110, 10));

        Amount.setForeground(new java.awt.Color(255, 255, 255));
        Amount.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 2, true));
        jPanel10.add(Amount, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 190, 230, -1));
        ...
        jPanel10.add(Cancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 390, 200, 40));

        addPayment.setBackground(new java.awt.Color(0, 53, 102));
        addPayment.setFont(new java.awt.Font("Gadugi", 1, 12)); // NOI18N
        ...
        jPanel10.add(addPayment, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 390, 190, 40));

        paymentMethod.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Payment Method", "CASH", "DEBIT CARD", "ONLINE PAYMENT" }));
        jPanel10.add(paymentMethod, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 230, 230, -1));
