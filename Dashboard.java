...
//        Bill
      ...
      // Logout
       ...
       private void saveToDatabase() {
        String number = carNum.getText();
        String brand = carBrand.getText();
        String model = carModel.getText();
        int year = Integer.parseInt(carYear.getText());
        String transmission = carTransmission.getSelectedItem().toString();
        String fuelType = carFuelType.getSelectedItem().toString();
        String color = carColor.getText();
        int seatingCapacity = Integer.parseInt(carSeats.getText());
        double price = Double.parseDouble(carPrice.getText());
        double discount = Double.parseDouble(carDiscount.getText());
        String status = carStatus.getSelectedItem().toString();
        String features = carFeatures.getText();

        // Database Connection and Insert
        try {
            String query = "INSERT INTO `cars`( `car_number`, `brand`, `model`, `year`, `Transmission`, `fuel_type`, `color`, `seating_capacity`, `price`, `discount`, `status`, `features`)  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        carModel.setText("");
        carYear.setText("");
        carTransmission.setSelectedIndex(0);
        carFuelType.setSelectedIndex(0);
        carColor.setText("");
        carSeats.setText("");
        carPrice.setText("");
        carDiscount.setText("");
        carStatus.setSelectedIndex(0);
        carFeatures.setText("");
    }
    ...
    private void initComponents() {
        ...
        carFeatures = new javax.swing.JTextField();
        ...
        carTransmission = new javax.swing.JComboBox<>();
        carColor = new javax.swing.JTextField();
        carSeats = new javax.swing.JTextField();
        carPrice = new javax.swing.JTextField();
        carDiscount = new javax.swing.JTextField();
        carFuelType = new javax.swing.JComboBox<>();
        ...
        jPanel10.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 3, true), "ADD   CAR", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Stencil", 1, 24), new java.awt.Color(2, 48, 71))); // NOI18N
        jPanel10.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(2, 48, 71));
        jLabel9.setText("CAR NUMBER");
        jPanel10.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, -1, -1));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(2, 48, 71));
        jLabel10.setText("BRAND");
        jPanel10.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 90, -1, -1));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(2, 48, 71));
        jLabel11.setText("MODEL");
        jPanel10.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, -1, -1));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(2, 48, 71));
        jLabel12.setText("YEAR");
        jPanel10.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, -1, -1));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(2, 48, 71));
        jLabel13.setText("FEATURES");
        jPanel10.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 490, -1, -1));

        carNum.setForeground(new java.awt.Color(255, 255, 255));
        carNum.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 2, true));
        jPanel10.add(carNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 50, 230, -1));

        carBrand.setForeground(new java.awt.Color(255, 255, 255));
        carBrand.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 2, true));
        carBrand.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                carBrandActionPerformed(evt);
            }
        });
        jPanel10.add(carBrand, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 90, 230, -1));

        carYear.setForeground(new java.awt.Color(255, 255, 255));
        carYear.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 2, true));
        jPanel10.add(carYear, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, 230, -1));

        carFeatures.setForeground(new java.awt.Color(255, 255, 255));
        carFeatures.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 2, true));
        carFeatures.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                carFeaturesActionPerformed(evt);
            }
        });
        jPanel10.add(carFeatures, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 490, 230, 20));

        jSeparator3.setBackground(new java.awt.Color(2, 48, 71));
        jSeparator3.setForeground(new java.awt.Color(2, 48, 71));
        jPanel10.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 120, 10));

        carModel.setForeground(new java.awt.Color(255, 255, 255));
        carModel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 2, true));
        jPanel10.add(carModel, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 130, 230, -1));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(2, 48, 71));
        jLabel14.setText("TRANSMISSION");
        jPanel10.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 210, -1, -1));

        jLabel15.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(2, 48, 71));
        jLabel15.setText("FUEL TYPE");
        jPanel10.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, -1, -1));

        jLabel16.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(2, 48, 71));
        jLabel16.setText("COLOR");
        jPanel10.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 290, -1, -1));

        jLabel17.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(2, 48, 71));
        jLabel17.setText("SEATING CAPACITY");
        jPanel10.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 330, -1, -1));

        jLabel18.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(2, 48, 71));
        jLabel18.setText("PRICE");
        jPanel10.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 370, -1, -1));

        jLabel19.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(2, 48, 71));
        jLabel19.setText("DISCOUNT");
        jPanel10.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 410, -1, -1));

        jLabel20.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(2, 48, 71));
        jLabel20.setText("STATUS");
        jPanel10.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 450, -1, -1));

        carStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Car Status", "Available", "Sold", "Not for Sell" }));
        carStatus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                carStatusActionPerformed(evt);
            }
        });
        jPanel10.add(carStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 440, 230, 30));

        carTransmission.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sleect Car Transmission", "Automatically", "Manual", " " }));
        jPanel10.add(carTransmission, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 200, 230, 30));

        carColor.setForeground(new java.awt.Color(255, 255, 255));
        carColor.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 2, true));
        carColor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                carColorActionPerformed(evt);
            }
        });
        jPanel10.add(carColor, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 290, 230, 20));

        carSeats.setForeground(new java.awt.Color(255, 255, 255));
        carSeats.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 2, true));
        carSeats.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                carSeatsActionPerformed(evt);
            }
        });
        jPanel10.add(carSeats, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 330, 230, 20));

        carPrice.setForeground(new java.awt.Color(255, 255, 255));
        carPrice.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 2, true));
        carPrice.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                carPriceActionPerformed(evt);
            }
        });
        jPanel10.add(carPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 370, 230, 20));

        carDiscount.setForeground(new java.awt.Color(255, 255, 255));
        carDiscount.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(2, 48, 71), 2, true));
        carDiscount.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                carDiscountActionPerformed(evt);
            }
        });
        jPanel10.add(carDiscount, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 410, 230, 20));

        carFuelType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Fuel Type", "Petrol", "Diesel" }));
        carFuelType.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                carFuelTypeActionPerformed(evt);
            }
        });
        jPanel10.add(carFuelType, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 240, 230, 30));
        ...
        jPanel10.add(Cancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 530, 190, 40));

        addCar.setBackground(new java.awt.Color(0, 53, 102));
        addCar.setFont(new java.awt.Font("Gadugi", 1, 12)); // NOI18N
        ...
        jPanel10.add(addCar, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 530, 190, 40));
    ...
    private void carFeaturesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_carFeaturesActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_carFeaturesActionPerformed
    ...
    private void carSeatsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_carSeatsActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_carSeatsActionPerformed
    ...
    private void carDiscountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_carDiscountActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_carDiscountActionPerformed
    ...
    private void carFuelTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_carFuelTypeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_carFuelTypeActionPerformed
    ...
    private javax.swing.JTextField carDiscount;
    private javax.swing.JTextField carFeatures;
    private javax.swing.JComboBox<String> carFuelType;
    private javax.swing.JTextField carModel;
    private javax.swing.JTextField carNum;
    private javax.swing.JTextField carPrice;
    private javax.swing.JTextField carSeats;
    private javax.swing.JComboBox<String> carStatus;
    private javax.swing.JComboBox<String> carTransmission;
